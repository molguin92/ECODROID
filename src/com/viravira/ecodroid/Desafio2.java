...
public class Desafio2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			int desafioint = desafios.getInt(numdesafio,
					desafiosazar.nextInt(40));
			...
			// TODO Bloquear checkboxes en el "futuro", que no pueden ser
			// realizados todavia
	...
	public void Completado(View view) {
		...
		SharedPreferences desafios = context.getSharedPreferences("Prefs", 0);
		...
		// "Para completar el desafío correctamente debes marcar TODOS los checkboxes",
		// duration);
		// toast.show();
		// return;
		// }
		...
		int puntajetotal = Integer.parseInt(puntaje)
				+ desafios.getInt("puntaje", 0);
		SharedPreferences.Editor editor = desafios.edit();
		...
		int duration = Toast.LENGTH_SHORT;
		Toast toast = Toast
				.makeText(context, getString(R.string.youvewon) + " " + puntaje
						+ " " + getString(R.string.pts) + "!", duration);
